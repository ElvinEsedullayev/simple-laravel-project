...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse @if(Request::segment(2)=='meqaleler') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item @if(Request::segment(2)=='meqaleler' and !Request::segment(3)) active @endif" href="{{route('admin.meqaleler.index')}}">Butun Meqaleler</a>
                    <a class="collapse-item @if(Request::segment(2)=='meqaleler' and Request::segment(3) =='olustur') active @endif"  href="{{route('admin.meqaleler.create')}}">Meqale Olustur</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" @if(Request::segment(2)=='categoriler') style="color: white; !inportant;" @endif href="{{route('admin.category.index')}}">
                <i class="fas fa-fw fa-list" @if(Request::segment(2)=='categoriler') style="color: white; !inportant;" @endif></i>
            ...
            <div id="collapsePage" class="collapse @if(Request::segment(2)=='sayfalar') show @endif" aria-labelledby="headingPage" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item @if(Request::segment(2)=='sayfalar' and !Request::segment(3)) active @endif" href="{{route('admin.sayfalar.index')}}">Butun Sayfalar</a>
                    <a class="collapse-item @if(Request::segment(2)=='sayfalar' and Request::segment(3) =='ekle') active @endif"  href="{{route('admin.sayfalar.ekle')}}">Sayfa Olustur</a>
                </div>
            </div>
        </li>
        <!-- Divider -->
        <hr class="sidebar-divider">
        <!-- Nav Item - Charts -->
        <li class="nav-item @if(Request::segment(2)=='ayarlar' and !Request::segment(3)) active @endif">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route('home')}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-globe fa-sm text-white-50"></i> Sayti Goruntule</a>
                </div>
